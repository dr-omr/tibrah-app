        ...
        <motion.div
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 pt-3" style={{ borderTop: `1px solid ${C}14` }}>
                    ...
                    <div className="flex-1 flex flex-col items-center gap-1 py-2 rounded-[12px]"
                        style={{ background: `${C}10`, border: `1px solid ${C}18` }}>
                        <Target className="w-4.5 h-4.5" style={{ color: C }} />
                        <span className="text-[8px] font-black" style={{ color: C }}>خطة أسبوعية</span>
                    </div>
                </div>
            </div>
        </motion.div>
    ...
    return (
        <div className="relative min-h-screen pb-28 overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <EscalationCard color={C} hints={FIKRI_ESCALATION} bookingHref="/book-appointment" />
