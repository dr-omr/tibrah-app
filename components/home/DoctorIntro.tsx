                        ...
                        <div className="bg-gradient-to-br from-white/80 to-white/40 rounded-[1.75rem] p-6">
                            <div className="flex flex-col items-center text-center">
                                ...
                                >
                                    ...
                                    <motion.div
                                        className="absolute -bottom-2 -right-2 w-10 h-10 gradient-primary rounded-full flex items-center justify-center shadow-lg ring-4 ring-white"
                                        whileTap={{ scale: 0.8, rotate: -10 }}
                                    >
                                        <Verified className="w-5 h-5 text-white" />
                                    </motion.div>
                                    <motion.div
                                        className="absolute -top-2 -left-2 w-8 h-8 gradient-gold rounded-full flex items-center justify-center shadow-lg ring-4 ring-white"
                                        whileTap={{ scale: 0.8, rotate: 10 }}
                                    >
